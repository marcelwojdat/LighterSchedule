"""
Django settings for lighterschedule_backend project.
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-s8i_)8q#&!grcqq0j050+_%_-cv)p5bh@55*i+k-_c29^a)!8n',
)
...
# Production hardening (enable when DJANGO_DEBUG=False)
if not DEBUG:
...
# Email (console in DEBUG by default; set EMAIL_BACKEND / SMTP for production)
